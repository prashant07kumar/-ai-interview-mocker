...
function AddNewInterviewer() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      console.log("AI Response:", MockJsonResponse);
      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Add details about your job position, experience, and tech stack.
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={onSubmit}>
            <div>
              <h2 className="font-medium text-lg mb-4">
                Add details about your job position/role and years of experience
              </h2>
              ...
              <div className="mb-3">
                ...
                <Textarea
                  placeholder="Ex. React, Node.js, MongoDB, MySQL"
                  required
                  value={jobDesc}
